		...
		me._information.logicBlock_size = function() {
			...
			if (me._information.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._information.ggCurrentLogicStateSize == 0) {
					me._information.style.width='80%';
